<template>
  <div class="msite">
    ...
    <HeaderTop :title="address.name">
      <RouterLink slot="search" to="/search" class="header_search">
        <i class="iconfont icon-xingtaiduICON_sousuo--"></i>
      </RouterLink>
      <RouterLink slot="login" to="/login" class="header_login">
...
export default {
  ...
  computed: {
    ...
    /* 根据categorys一维数组生成二维数组，元素小数组个数最大为8 */
    categorysArr () {
  ...
  watch: {
    categorys (value) { // 异步执行，在页面更新之前，所以youbug
      // 界面更新立即创建swiper对象
