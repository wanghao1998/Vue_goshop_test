        ...
        <form @submit.prevent="logins">
          <div :class="{on: loginWay}">
            <section class="login_message">
              ...
              <button  :disabled="!rightPhone" class="get_verification"  :class="{right_phone: rightPhone}" @click.prevent="getCode">{{btntext > 0 ? `已发送（${btntext}）` : '点击获取验证码'}}</button>
            </section>
...
export default {
  ...
  data () {
    return {
      loginWay: true, // true 短信登录， false 密码登陆
      phone: '',
      code: '',
      name: '',
      pwd: '',
